...
import com.lovi.searchbox.api.CommonSearchApi;
...
public class SearchBoxConfiguration{
	...
	@Bean
	public CommonSearchApi commonSearchApi(SearchBoxOperations redBoxService) throws Exception{
		return new CommonSearchApi();
	}
